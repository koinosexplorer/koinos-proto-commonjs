...
var koinos_transaction_store_transaction_store_pb = require('../../../koinos/transaction_store/transaction_store_pb.js');
goog.object.extend(proto, koinos_transaction_store_transaction_store_pb);
goog.exportSymbol('proto.koinos.rpc.transaction_store.get_transactions_by_id_request', null, global);
goog.exportSymbol('proto.koinos.rpc.transaction_store.get_transactions_by_id_response', null, global);
goog.exportSymbol('proto.koinos.rpc.transaction_store.transaction_store_request', null, global);
goog.exportSymbol('proto.koinos.rpc.transaction_store.transaction_store_request.RequestCase', null, global);
goog.exportSymbol('proto.koinos.rpc.transaction_store.transaction_store_response', null, global);
goog.exportSymbol('proto.koinos.rpc.transaction_store.transaction_store_response.ResponseCase', null, global);
/**
...
proto.koinos.rpc.transaction_store.get_transactions_by_id_response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    koinos_transaction_store_transaction_store_pb.transaction_item.toObject, includeInstance)
  };
...
proto.koinos.rpc.transaction_store.get_transactions_by_id_response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new koinos_transaction_store_transaction_store_pb.transaction_item;
      reader.readMessage(value,koinos_transaction_store_transaction_store_pb.transaction_item.deserializeBinaryFromReader);
...
proto.koinos.rpc.transaction_store.get_transactions_by_id_response.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      koinos_transaction_store_transaction_store_pb.transaction_item.serializeBinaryToWriter
    );
  }
};
...
proto.koinos.rpc.transaction_store.get_transactions_by_id_response.prototype.getTransactionsList = function() {
  return /** @type{!Array<!proto.koinos.transaction_store.transaction_item>} */ (
    jspb.Message.getRepeatedWrapperField(this, koinos_transaction_store_transaction_store_pb.transaction_item, 1));
};
...
goog.object.extend(exports, proto.koinos.rpc.transaction_store);
