...
goog.exportSymbol('proto.koinos.broadcast.event_parcel', null, global);
goog.exportSymbol('proto.koinos.broadcast.fork_heads', null, global);
goog.exportSymbol('proto.koinos.broadcast.gossip_status', null, global);
goog.exportSymbol('proto.koinos.broadcast.mempool_accepted', null, global);
goog.exportSymbol('proto.koinos.broadcast.transaction_accepted', null, global);
goog.exportSymbol('proto.koinos.broadcast.transaction_failed', null, global);
/**
...
proto.koinos.broadcast.transaction_accepted.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    receipt: (f = msg.getReceipt()) && koinos_protocol_protocol_pb.transaction_receipt.toObject(includeInstance, f),
...
proto.koinos.broadcast.transaction_accepted.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new koinos_protocol_protocol_pb.transaction_receipt;
      reader.readMessage(value,koinos_protocol_protocol_pb.transaction_receipt.deserializeBinaryFromReader);
...
proto.koinos.broadcast.transaction_accepted.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      koinos_protocol_protocol_pb.transaction_receipt.serializeBinaryToWriter
    );
  }
  f = message.getHeight();
  if (parseInt(f, 10) !== 0) {
...
proto.koinos.broadcast.transaction_accepted.prototype.getReceipt = function() {
  return /** @type{?proto.koinos.protocol.transaction_receipt} */ (
    jspb.Message.getWrapperField(this, koinos_protocol_protocol_pb.transaction_receipt, 2));
};
...
proto.koinos.broadcast.block_accepted.prototype.getReceipt = function() {
  return /** @type{?proto.koinos.protocol.block_receipt} */ (
    jspb.Message.getWrapperField(this, koinos_protocol_protocol_pb.block_receipt, 2));
};
...
proto.koinos.broadcast.event_parcel.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    event: (f = msg.getEvent()) && koinos_protocol_protocol_pb.event_data.toObject(includeInstance, f)
  };
...
proto.koinos.broadcast.event_parcel.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new koinos_protocol_protocol_pb.event_data;
      reader.readMessage(value,koinos_protocol_protocol_pb.event_data.deserializeBinaryFromReader);
      msg.setEvent(value);
      break;
    default:
      reader.skipField();
...
proto.koinos.broadcast.event_parcel.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      koinos_protocol_protocol_pb.event_data.serializeBinaryToWriter
    );
  }
};
...
proto.koinos.broadcast.event_parcel.prototype.getEvent = function() {
  return /** @type{?proto.koinos.protocol.event_data} */ (
    jspb.Message.getWrapperField(this, koinos_protocol_protocol_pb.event_data, 4));
};
