...
goog.exportSymbol('proto.koinos.chain.enum_type', null, global);
goog.exportSymbol('proto.koinos.chain.list_type', null, global);
goog.exportSymbol('proto.koinos.chain.value_type', null, global);
goog.exportSymbol('proto.koinos.chain.value_type.KindCase', null, global);
/**
...
proto.koinos.chain.value_type.toObject = function(includeInstance, msg) {
  var f, obj = {
    messageValue: (f = msg.getMessageValue()) && google_protobuf_any_pb.Any.toObject(includeInstance, f),
